...
export default function Receivables() {
  ...
  return (
    <ReportView
      title="Дебиторка"
      lead="По обязующим сделкам (и по всем со сделанными оплатами), кроме проигранных. Остаток = сумма − оплачено + корректировка. Оплаты «в ожидании» долг не гасят (отдельная колонка). Отрицательный остаток — переплата."
      state={state}
    >
      {(data) => (
        <div className="panel">
