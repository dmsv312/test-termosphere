  ...
  return (
    <section>
      ...
      <p className="muted page-lead">
        Какие проблемы нашлись в выгрузке при нормализации и что мы с ними сделали. Три варианта
        реакции: исправление (привели к единому виду), карантин (не включили в отчёты, но сохранили
        запись), флаг (не ошибка, а деловой сигнал — оставили и пометили).
      </p>
